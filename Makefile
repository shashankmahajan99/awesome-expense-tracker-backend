...
podman-server-run:
	podman run -d -p 8080:8080 -p 8081:8081 -e PORT=8080 -e GRPC_PORT=8081 -e MYSQLUSER=root -e MYSQLPASSWORD=password -e MYSQLADDR=192.168.29.188:3306 -e MYSQLDBNAME=awesome_expense_tracker --name awesome-expense-tracker-backend --rm awesome-expense-tracker-backend
